...
- 批次 A、B 的 72 个算法目录已经提供独立 `solution.py`、公开样例和隐藏测试，对应 288 道可在浏览器中运行与提交的训练题；覆盖排序、贪心、回溯、最短路、最小生成树和动态规划等高频范式。
- 其余 728 道题已建立稳定题号和讲解骨架，按根目录 `PROBLEM_TODO.md` 的 C-F 批次继续补全，界面会明确显示“讲解已收录”。

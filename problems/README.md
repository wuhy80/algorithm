...
- 批次 A-C 的 91 个算法目录已经提供独立 `solution.py`、公开样例和隐藏测试，对应 364 道可在浏览器中运行与提交的训练题；覆盖排序、贪心、回溯、图遍历、匹配、网络流和动态规划等高频范式。
- 其余 652 道题已建立稳定题号和讲解骨架，按根目录 `PROBLEM_TODO.md` 的 D-F 批次继续补全，界面会明确显示“讲解已收录”。
